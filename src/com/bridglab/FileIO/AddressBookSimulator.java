...
public class AddressBookSimulator {
    ...
    private Map<String, ContactAvi> cityPersonMap = new HashMap<>();
    private Map<String, ContactAvi> statePersonMap = new HashMap<>();
    ...
    public void showContactsByCity(){
        ...
        List<List<ContactAvi>> listOfCityContactsList;
        listOfCityContactsList = new ArrayList<>();
        java.util.List<ContactAvi> cityContactList;
        ...
        addressBookSimulator.cityPersonMap.put(city, (ContactAvi) listOfCityContactsList);
    ...
    public void showContactByState(){
        ...
        List<List<ContactAvi>> listOfStateContactsList = new ArrayList<>();
        java.util.List<ContactAvi> stateContactList;
        for (Map.Entry<String, AddressBookService> entry : addressBookSimulator.booksMap.entrySet()) {
        ...
        addressBookSimulator.statePersonMap.put(state, (ContactAvi) listOfStateContactsList);
    ...
    public void sortByFirstName() {
        addressBookSimulator.booksMap.entrySet().forEach(entry -> {
            System.out.println("sorted contacts by first name: " + entry.getValue()
                    .getContactsList()
                    .stream()
                    .sorted(Comparator.comparing(ContactAvi::getFirstName))
                    .collect(Collectors.toList()));
        });
    }
    ...
    public void sortContactByCity() {
        addressBookSimulator.booksMap.entrySet().forEach(entry -> {
            System.out.println("sorted contacts by city: " + entry.getValue()
                    .getContactsList()
                    .stream()
                    .sorted(Comparator.comparing(ContactAvi::getCity))
                    .collect(Collectors.toList()));
        });
    }
    ...
    public void sortContactByState() {
        addressBookSimulator.booksMap.entrySet().forEach(entry -> {
            System.out.println("sorted contacts by state: " + entry.getValue()
                    .getContactsList()
                    .stream()
                    .sorted(Comparator.comparing(ContactAvi::getState))
                    .collect(Collectors.toList()));
        });
    }
    ...
    public void sortContactByZip() {
        addressBookSimulator.booksMap.entrySet().forEach(entry -> {
            System.out.println("sorted contacts by zip: " + entry.getValue()
                    .getContactsList()
                    .stream()
                    .sorted(Comparator.comparing(ContactAvi::getZip))
                    .collect(Collectors.toList()));
        });
    }
