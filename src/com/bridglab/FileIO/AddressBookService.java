...
public class AddressBookService {
    ...
    List<ContactAvi> contactsList = new ArrayList<>();
    ScannerForAddressBook scannerForAddressBook = new ScannerForAddressBook();

    public List<ContactAvi> getContactsList() {
        return contactsList;
    }
    ...
    public void addContact() {
        ContactAvi contacts = new ContactAvi();
    ...
    public void editDetails(String name) {
        if (isContactExist(name) == true) {
            ContactAvi contact = getContact(name);
     ...
     */
    public void deleteContact(ContactAvi contact) {
     ...
     */
    private ContactAvi getContact(String name) {
        ContactAvi foundContact = contactsList.stream()
                .filter(contact ->
            ...
            switch (option) {
                ...
                case 3:
                    ...
                    if (isContactExist(name1)) {
                        ContactAvi contact = getContact(name1);
